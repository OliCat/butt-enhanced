...
# Version corrigée avec gestion des signaux pour éviter le blocage à la fermeture
# Auteur: Assistant pour projet StereoTool SDK
# Version: 1.1

set -e # Arrêter en cas d'erreur

echo "🔧 Compilation BUTT Intel avec gestion des signaux..."
echo "====================================================="
...
create_intel_bundle() {
    ...
    # Création du Info.plist avec gestion des signaux
...
echo ""
echo "🎉 Compilation Intel avec gestion des signaux terminée!"
echo "======================================================"
...
echo ""
echo "⚠️  Note: Ce bundle devrait maintenant se fermer proprement" 