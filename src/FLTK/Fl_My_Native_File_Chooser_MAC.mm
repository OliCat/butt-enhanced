...
@interface ButtFLopenDelegate : NSObject 
...
- (ButtFLopenDelegate*)setPopup:(NSPopUpButton*)popup filter_pattern:(char**)pattern;
- (BOOL)panel:(id)sender shouldShowFilename:(NSString *)filename;
- (BOOL)panel:(id)sender shouldEnableURL:(NSURL *)url;
@end
@implementation ButtFLopenDelegate
- (ButtFLopenDelegate*)setPopup:(NSPopUpButton*)popup filter_pattern:(char**)pattern
{
    nspopup = popup;
...
@interface ButtFLsaveDelegate : NSObject 
#if MAC_OS_X_VERSION_MAX_ALLOWED >= MAC_OS_X_VERSION_10_6
<NSOpenSavePanelDelegate>
#endif
{
...
- (void)option:(BOOL)o;
@end
@implementation ButtFLsaveDelegate
- (NSString *)panel:(id)sender userEnteredFilename:(NSString *)filename confirmed:(BOOL)okFlag
{
...
int Fl_My_Native_File_Chooser::post() {
    ...
    if ( is_open_panel ) {
        if (_filt_total) {
            ...
            ButtFLopenDelegate *openDelegate = [[[ButtFLopenDelegate alloc] init] autorelease];
            [openDelegate setPopup:popup filter_pattern:_filt_patt];
            [(NSOpenPanel*)_panel setDelegate:openDelegate];
        }
    }
    else {
        ButtFLsaveDelegate *saveDelegate = [[[ButtFLsaveDelegate alloc] init] autorelease];
