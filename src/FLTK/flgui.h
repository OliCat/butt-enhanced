...
public:
  Fl_Check_Button *check_aes67_enable;
private:
  inline void cb_check_aes67_enable_i(Fl_Check_Button*, void*);
  static void cb_check_aes67_enable(Fl_Check_Button*, void*);
public:
  Fl_Box *label_aes67_ip;
  Fl_Input *input_aes67_ip;
private:
  inline void cb_input_aes67_ip_i(Fl_Input*, void*);
  static void cb_input_aes67_ip(Fl_Input*, void*);
public:
  Fl_Box *label_aes67_port;
  Fl_Value_Input *input_aes67_port;
private:
  inline void cb_input_aes67_port_i(Fl_Value_Input*, void*);
  static void cb_input_aes67_port(Fl_Value_Input*, void*);
public:
  Fl_Box *label_aes67_iface;
  Fl_Input *input_aes67_iface;
private:
  inline void cb_input_aes67_iface_i(Fl_Input*, void*);
  static void cb_input_aes67_iface(Fl_Input*, void*);
public:
  Fl_Check_Button *check_aes67_ptp;
private:
  inline void cb_check_aes67_ptp_i(Fl_Check_Button*, void*);
  static void cb_check_aes67_ptp(Fl_Check_Button*, void*);
public:
  Fl_Check_Button *check_aes67_sap;
private:
  inline void cb_check_aes67_sap_i(Fl_Check_Button*, void*);
  static void cb_check_aes67_sap(Fl_Check_Button*, void*);
public:
  Fl_Check_Button *check_aes67_loopback;
private:
  inline void cb_check_aes67_loopback_i(Fl_Check_Button*, void*);
  static void cb_check_aes67_loopback(Fl_Check_Button*, void*);
public:
  Fl_Button *button_aes67_copy_sdp;
private:
  inline void cb_button_aes67_copy_sdp_i(Fl_Button*, void*);
  static void cb_button_aes67_copy_sdp(Fl_Button*, void*);
public:
  Fl_Box *label_aes67_status;
  // Core Audio widgets - SUPPRIMÉS
  // Fl_Check_Button *check_core_audio_enable;
  // inline void cb_check_core_audio_enable_i(Fl_Check_Button*, void*);
  // static void cb_check_core_audio_enable(Fl_Check_Button*, void*);
  // Fl_Box *label_core_audio_device;
  // Fl_Choice *choice_core_audio_device;
  // inline void cb_choice_core_audio_device_i(Fl_Choice*, void*);
  // static void cb_choice_core_audio_device(Fl_Choice*, void*);
  // Fl_Box *label_core_audio_buffer;
  // Fl_Value_Input *input_core_audio_buffer;
  // inline void cb_input_core_audio_buffer_i(Fl_Value_Input*, void*);
  // static void cb_input_core_audio_buffer(Fl_Value_Input*, void*);
  // Fl_Check_Button *check_core_audio_exclusive;
  // inline void cb_check_core_audio_exclusive_i(Fl_Check_Button*, void*);
  // static void cb_check_core_audio_exclusive(Fl_Check_Button*, void*);
  // Fl_Box *label_core_audio_status;
  // Fl_Box *label_core_audio_latency;
...
private:
  inline void cb_check_stereo_tool_stream_i(Fl_Check_Button*, void*);
  static void cb_check_stereo_tool_stream(Fl_Check_Button*, void*);
public:
  Fl_Check_Button *check_stereo_tool_record;
private:
  inline void cb_check_stereo_tool_record_i(Fl_Check_Button*, void*);
  static void cb_check_stereo_tool_record(Fl_Check_Button*, void*);
public:
  Fl_Check_Button *check_stereo_tool_replace_dsp;
private:
  inline void cb_check_stereo_tool_replace_dsp_i(Fl_Check_Button*, void*);
  static void cb_check_stereo_tool_replace_dsp(Fl_Check_Button*, void*);
public:
  Fl_Box *label_stereo_tool_status;
  Fl_Input *input_stereo_tool_license;
private:
  inline void cb_input_stereo_tool_license_i(Fl_Input*, void*);
  static void cb_input_stereo_tool_license(Fl_Input*, void*);
public:
  Fl_Button *button_stereo_tool_test_license;
private:
  inline void cb_button_stereo_tool_test_license_i(Fl_Button*, void*);
  static void cb_button_stereo_tool_test_license(Fl_Button*, void*);
public:
  Fl_Box *label_stereo_tool_latency;
  Fl_Choice *choice_stereo_tool_preset_stream;
private:
  inline void cb_choice_stereo_tool_preset_stream_i(Fl_Choice*, void*);
  static void cb_choice_stereo_tool_preset_stream(Fl_Choice*, void*);
public:
  Fl_Button *button_stereo_tool_load_preset_stream;
private:
  inline void cb_button_stereo_tool_load_preset_stream_i(Fl_Button*, void*);
  static void cb_button_stereo_tool_load_preset_stream(Fl_Button*, void*);
public:
  Fl_Choice *choice_stereo_tool_preset_record;
private:
  inline void cb_choice_stereo_tool_preset_record_i(Fl_Choice*, void*);
  static void cb_choice_stereo_tool_preset_record(Fl_Choice*, void*);
public:
  Fl_Button *button_stereo_tool_load_preset_record;
private:
  inline void cb_button_stereo_tool_load_preset_record_i(Fl_Button*, void*);
  static void cb_button_stereo_tool_load_preset_record(Fl_Button*, void*);
public:
  Fl_Button *button_stereo_tool_save_preset;
private:
  inline void cb_button_stereo_tool_save_preset_i(Fl_Button*, void*);
  static void cb_button_stereo_tool_save_preset(Fl_Button*, void*);
public:
